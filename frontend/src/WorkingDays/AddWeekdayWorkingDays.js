...
class AddWeekdayWorkingDays extends Component{
    ...
    onSubmit = (e) => {
        ...
        if(!this.state.edit){
            axios.post('/workingdays/add', day)
                .then(res => {
                    if(res.data.success){
            ...
            axios.put('/workingdays/update', day)
                .then(res => {
                    if(res.data.success){
    ...
    render() {
        return (
            <div className="main">
                <WorkingDaysNav/>
                <div className="form">
                    <h3>{this.state.edit? "Update" : "Add"} Weekday</h3>
                    <br/>
...
export default withRouter(AddWeekdayWorkingDays);