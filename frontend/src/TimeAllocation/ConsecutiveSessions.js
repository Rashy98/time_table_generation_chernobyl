...
export default class ConsecutiveSessions extends Component{
    ...
    render() {
        ...
        return (
            <div className="main">
                <TagNav/>
                <h3> Consecutive Sessions Allocations</h3>
                <div className="form">
                    <form className="" >
                        <div className="form-group mx-sm-3 mb-2">
                            <label style={{fontSize: '16px', color: "mediumslateblue"}} htmlFor="YearInputSelect">Select Sessions to Allocate</label><br/>
                        ...
                        <button style={{marginLeft:'40%'}} className="btn mb-2" onClick={this.AddTag}>
                            Add Tag
                        </button>
                    </form>
                    <br/>
