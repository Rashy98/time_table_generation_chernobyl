...
class ParallelSessions extends Component{
    ...
    AddSessionAllocation(e) {
        ...
        const Parsession = {
            ...
            ParallelSessionID:  this.state.selectedID1
        }
        const Parsession1 = {
            _id:this.state.selectedID1,
            ParallelSessionID:  this.state.selectedID
        }
        ...
        // }
        console.log(Parsession);
        console.log(Parsession1);
        axios.post("/session/pushParSession/",Parsession)
            .then(res => console.log(res.data));
        axios.post("/session/pushParSession1/",Parsession1)
            .then(res => console.log(res.data));

        alert('Parallel Sessions Allocated!');
        this.setState({
            selectedSession:" ",
            selectedSession1:" ",
